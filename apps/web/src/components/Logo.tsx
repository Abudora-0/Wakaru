...
export function Logo({ size = 40, tone = "ink", title = "Wakaru", className }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="82" cy="26" r="6" fill={drops} />
      <circle cx="89" cy="43" r="3.2" fill={drops} opacity="0.62" />
      <circle cx="84" cy="56" r="1.8" fill={drops} opacity="0.4" />
    </svg>
  );
}
